 ...
 * default: static char *font = "Liberation Mono:pixelsize=12:antialias=true:autohint=true";
 */
static char *font = "Cousine Nerd Font:style=regular:antialias=true:pixelsize=12";
...
const unsigned mousescrollspeed = 12;
